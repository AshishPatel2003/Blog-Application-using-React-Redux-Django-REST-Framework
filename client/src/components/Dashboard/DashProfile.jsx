...
function DashProfile() {
	...
	return (
        ...
        <TextInput type="text" id="first_name" placeholder="First Name" defaultValue={currentUser.first_name} />
        <TextInput type="text" id="last_name" placeholder="Last Name" defaultValue={currentUser.last_name} />
